 ...
 * 2016-08-16 海外前端小组
 * 本地缓存系统（UMD规范）
 * 说明文档：http://wiki.i37wan.net/pages/viewpage.action?pageId=11539112
 */
(function (root, factory) {
    ...
    /**
     * [init 初始化gmStore对象，可配置get()返回数据的类型，过期时间设置方式等]
     * @Authorlingtong
     * @DateTime       2016-08-16 18:28:10
     * @param          {[type]}                 config [系统配置参数]
     * @return         {[type]}                        [description]
     */
    gmStore.prototype.init = function (config) {
        var that = this;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.save = function (param, callback) {
        var that = this;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.del = function (param, callback) {
        var that = this;
        if (!that.__typeof(param)) return;
        if (!that.__checkKeyName(param.keyName)) return;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.get = function (param, callback) {
        var that = this;
        if (!that.__typeof(param)) return;
        if (!that.__checkKeyName(param.keyName)) return;
        var keyName = param.keyName;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.update = function (param, callback) {
        var that = this;
        if (!that.__typeof(param)) return;
        if (!that.__checkKeyName(param.keyName)) return;
        that.__add(param, callback);
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.flush = function (callback) {
        var that = this;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.getSize = function (param, callback) {
        var size = 0;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.getRemainSize = function (callback) {
        var that = this;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype._flushDirtyRead = function (date, callback) {
        var that = this;
        var flushSize = 0;
     ...
     * @return         {[type]}                          [description]
     */
    gmStore.prototype.__add = function (param, callback) {
        var that = this;
        var keyName = param.keyName;
                ...
                that._flushDirtyRead(0, function (flushSize) {
                    if (flushSize > JSON.stringify(item).length) {
                        try {
                            ...
                            that.__log(err + ', ' + 'gmStore has flushed the dirty data in localStorage, but it is not big enough for your item!');
                        }
                    }
                    else {
                        that.__log(err + ', ' + 'gmStore has flushed the dirty data in localStorage, but it is not big enough for your item!');
     ...
     * @return         {[type]}                       [回调函数]
     */
    gmStore.prototype.__typeof = function (param) {
        var that = this;
     ...
     * @return         {[type]}                        [description]
     */
    gmStore.prototype.__formatDateTime = function (expire) {
     ...
     * @return         {[type]}                            [description]
     */
    gmStore.prototype.__checkDateTimeFormat = function (expireDate) {
        var that = this;
     ...
     * @return         {[type]}                         [description]
     */
    gmStore.prototype.__checkKeyName = function (keyName) {
        var that = this;
     ...
     * @return         {[type]}                 [description]
     */
    gmStore.prototype.__checkUserAgent = function () {
     ...
     * @return         {[type]}                   [description]
     */
    gmStore.prototype.__log = function(a, b, c, d, e) {
        var that = this;
