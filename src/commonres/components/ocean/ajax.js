define(function() {
    var Ajax = function($) {
        ...
        this.getResponsePropertiesLength = function(responseData) {
            var i = 0;
        ...
        this.jsonp = function(url, parameter, callback) {
            $.ajax({
                url: url + "&params=" + JSON.stringify(parameter),
                data: {
                    forward: ""
                },
                type: "get",
                ...
                success: function(response) {
                    if (1 == response.result) {
                        ...
                        callback(response.msg, response.data, response);
                    }
                },
                error: function(e) {
